...
namespace HelpDesk
{
    public partial class changePswdAdmin : System.Web.UI.Page
    {
        SqlConnection cn;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (txtOldPwd.Text == pswdInsession)
            {
                ...
                cn.Open();
                string updtPswd = "update adminLogin set password = '" + txtRpswd.Text.Trim() + "' where userName ='" + UnameInsession + "'";
